...
for subfolder in subfolders:
    ...
    with h5py.File(file_path, 'r') as hdf_file:
        ...
        dataset_id = subfolder.split('_')[-1]
        ...
        for i, frame_bytes in enumerate(frames):
            ...
            image.save(f"{image_path}/{i:04}_{keyframes[i]:04}_{dataset_id}.jpg")
            print(f"Saved {image_path}/{i:04}_{keyframes[i]:04}_{dataset_id}.jpg")
